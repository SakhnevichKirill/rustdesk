...
pub fn invoke_handler(builder: Builder<Wry>) -> Builder<Wry>{
    builder.invoke_handler(tauri::generate_handler![
        ...
        tauri_session_handler::read_dir,
        tauri_session_handler::remove_dir,
        tauri_session_handler::create_dir,
        tauri_session_handler::remove_file,
        tauri_session_handler::read_remote_dir,
        ...
        tauri_session_handler::cancel_job,
        tauri_session_handler::send_files,
        tauri_session_handler::add_job,
        tauri_session_handler::resume_job,
