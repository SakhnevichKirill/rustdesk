...
pub struct DisplayInfo {
    ...
    pub online: bool,
    // @@protoc_insertion_point(field:hbb.DisplayInfo.cursor_embeded)
    pub cursor_embeded: bool,
    #[serde(skip)]
    // special fields
...
impl DisplayInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "cursor_embeded",
            |m: &DisplayInfo| { &m.cursor_embeded },
            |m: &mut DisplayInfo| { &mut m.cursor_embeded },
        ));
...
impl ::protobuf::Message for DisplayInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                56 => {
                    self.cursor_embeded = is.read_bool()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cursor_embeded != false {
            os.write_bool(7, self.cursor_embeded)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
pub struct SwitchDisplay {
    ...
    pub height: i32,
    // @@protoc_insertion_point(field:hbb.SwitchDisplay.cursor_embeded)
    pub cursor_embeded: bool,
    // special fields
...
impl SwitchDisplay {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "cursor_embeded",
            |m: &SwitchDisplay| { &m.cursor_embeded },
            |m: &mut SwitchDisplay| { &mut m.cursor_embeded },
        ));
...
impl ::protobuf::Message for SwitchDisplay {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cursor_embeded != false {
            os.write_bool(6, self.cursor_embeded)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
pub struct VideoCodecState {
    ...
    pub score_h265: i32,
    // @@protoc_insertion_point(field:hbb.VideoCodecState.perfer)
    pub perfer: ::protobuf::EnumOrUnknown<video_codec_state::PerferCodec>,
    // special fields
...
impl VideoCodecState {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "perfer",
            |m: &VideoCodecState| { &m.perfer },
            |m: &mut VideoCodecState| { &mut m.perfer },
        ));
...
impl ::protobuf::Message for VideoCodecState {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.perfer = is.read_enum_or_unknown()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.perfer != ::protobuf::EnumOrUnknown::new(video_codec_state::PerferCodec::Auto) {
            my_size += ::protobuf::rt::int32_size(4, self.perfer.value());
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.perfer != ::protobuf::EnumOrUnknown::new(video_codec_state::PerferCodec::Auto) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.perfer))?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn clear(&mut self) {
        ...
        self.score_h264 = 0;
        self.score_h265 = 0;
        self.perfer = ::protobuf::EnumOrUnknown::new(video_codec_state::PerferCodec::Auto);
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static VideoCodecState {
        static instance: VideoCodecState = VideoCodecState {
            ...
            score_h264: 0,
            score_h265: 0,
            perfer: ::protobuf::EnumOrUnknown::from_i32(0),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod video_codec_state {
    #[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
    // @@protoc_insertion_point(enum:hbb.VideoCodecState.PerferCodec)
    pub enum PerferCodec {
        // @@protoc_insertion_point(enum_value:hbb.VideoCodecState.PerferCodec.Auto)
        Auto = 0,
        // @@protoc_insertion_point(enum_value:hbb.VideoCodecState.PerferCodec.VPX)
        VPX = 1,
        // @@protoc_insertion_point(enum_value:hbb.VideoCodecState.PerferCodec.H264)
        H264 = 2,
        // @@protoc_insertion_point(enum_value:hbb.VideoCodecState.PerferCodec.H265)
        H265 = 3,
    }

    impl ::protobuf::Enum for PerferCodec {
        const NAME: &'static str = "PerferCodec";

        fn value(&self) -> i32 {
            *self as i32
        }

        fn from_i32(value: i32) -> ::std::option::Option<PerferCodec> {
            match value {
                0 => ::std::option::Option::Some(PerferCodec::Auto),
                1 => ::std::option::Option::Some(PerferCodec::VPX),
                2 => ::std::option::Option::Some(PerferCodec::H264),
                3 => ::std::option::Option::Some(PerferCodec::H265),
                _ => ::std::option::Option::None
            }
        }

        const VALUES: &'static [PerferCodec] = &[
            PerferCodec::Auto,
            PerferCodec::VPX,
            PerferCodec::H264,
            PerferCodec::H265,
    ...
    impl ::protobuf::EnumFull for PerferCodec {
        fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().enum_by_package_relative_name("VideoCodecState.PerferCodec").unwrap()).clone()
        }
    ...
    impl ::std::default::Default for PerferCodec {
        fn default() -> Self {
            PerferCodec::Auto
        }
    }
    ...
    impl PerferCodec {
        pub(in super) fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
            ::protobuf::reflect::GeneratedEnumDescriptorData::new::<PerferCodec>("VideoCodecState.PerferCodec")
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02pk\x18\x02\x20\x01(\x0cR\x02pk\"\xaa\x01\n\x0bDisplayInfo\x12\x0c\n\
    ...
    \x20\x01(\tR\x04text\"-\n\x08Features\x12!\n\x0cprivacy_mode\x18\x01\x20\
    \x01(\x08R\x0bprivacyMode\";\n\x11SupportedEncoding\x12\x12\n\x04h264\
    \x18\x01\x20\x01(\x08R\x04h264\x12\x12\n\x04h265\x18\x02\x20\x01(\x08R\
    ...
    \x01(\x05R\x06height\x12%\n\x0ecursor_embeded\x18\x06\x20\x01(\x08R\rcur\
    sorEmbeded\"\xc6\x01\n\x0ePermissionInfo\x12>\n\npermission\x18\x01\x20\
    \x01(\x0e2\x1e.hbb.PermissionInfo.PermissionR\npermission\x12\x18\n\x07e\
    nabled\x18\x02\x20\x01(\x08R\x07enabled\"Z\n\nPermission\x12\x0c\n\x08Ke\
    yboard\x10\0\x12\r\n\tClipboard\x10\x02\x12\t\n\x05Audio\x10\x03\x12\x08\
    \n\x04File\x10\x04\x12\x0b\n\x07Restart\x10\x05\x12\r\n\tRecording\x10\
    \x06\"\xdc\x01\n\x0fVideoCodecState\x12\x1b\n\tscore_vpx\x18\x01\x20\x01\
    (\x05R\x08scoreVpx\x12\x1d\n\nscore_h264\x18\x02\x20\x01(\x05R\tscoreH26\
    4\x12\x1d\n\nscore_h265\x18\x03\x20\x01(\x05R\tscoreH265\x128\n\x06perfe\
    r\x18\x04\x20\x01(\x0e2\x20.hbb.VideoCodecState.PerferCodecR\x06perfer\"\
    4\n\x0bPerferCodec\x12\x08\n\x04Auto\x10\0\x12\x07\n\x03VPX\x10\x01\x12\
    \x08\n\x04H264\x10\x02\x12\x08\n\x04H265\x10\x03\"\x89\x06\n\rOptionMess\
    age\x126\n\rimage_quality\x18\x01\x20\x01(\x0e2\x11.hbb.ImageQualityR\
    \x0cimageQuality\x12R\n\x16lock_after_session_end\x18\x02\x20\x01(\x0e2\
    \x1d.hbb.OptionMessage.BoolOptionR\x13lockAfterSessionEnd\x12K\n\x12show\
    _remote_cursor\x18\x03\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\
    \x10showRemoteCursor\x12@\n\x0cprivacy_mode\x18\x04\x20\x01(\x0e2\x1d.hb\
    b.OptionMessage.BoolOptionR\x0bprivacyMode\x12>\n\x0bblock_input\x18\x05\
    \x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\nblockInput\x120\n\x14c\
    ustom_image_quality\x18\x06\x20\x01(\x05R\x12customImageQuality\x12B\n\r\
    disable_audio\x18\x07\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\
    \x0cdisableAudio\x12J\n\x11disable_clipboard\x18\x08\x20\x01(\x0e2\x1d.h\
    bb.OptionMessage.BoolOptionR\x10disableClipboard\x12O\n\x14enable_file_t\
    ransfer\x18\t\x20\x01(\x0e2\x1d.hbb.OptionMessage.BoolOptionR\x12enableF\
    ileTransfer\x12@\n\x11video_codec_state\x18\n\x20\x01(\x0b2\x14.hbb.Vide\
    oCodecStateR\x0fvideoCodecState\x12\x1d\n\ncustom_fps\x18\x0b\x20\x01(\
    \x05R\tcustomFps\")\n\nBoolOption\x12\n\n\x06NotSet\x10\0\x12\x06\n\x02N\
    o\x10\x01\x12\x07\n\x03Yes\x10\x02\"\x86\x01\n\tTestDelay\x12\x12\n\x04t\
    ime\x18\x01\x20\x01(\x03R\x04time\x12\x1f\n\x0bfrom_client\x18\x02\x20\
    \x01(\x08R\nfromClient\x12\x1d\n\nlast_delay\x18\x03\x20\x01(\rR\tlastDe\
    lay\x12%\n\x0etarget_bitrate\x18\x04\x20\x01(\rR\rtargetBitrate\"_\n\tPu\
    blicKey\x12)\n\x10asymmetric_value\x18\x01\x20\x01(\x0cR\x0fasymmetricVa\
    lue\x12'\n\x0fsymmetric_value\x18\x02\x20\x01(\x0cR\x0esymmetricValue\"\
    ...
    \x02\x20\x01(\x03R\ttimestamp\"d\n\nMessageBox\x12\x18\n\x07msgtype\x18\
    \x01\x20\x01(\tR\x07msgtype\x12\x14\n\x05title\x18\x02\x20\x01(\tR\x05ti\
    tle\x12\x12\n\x04text\x18\x03\x20\x01(\tR\x04text\x12\x12\n\x04link\x18\
    \x04\x20\x01(\tR\x04link\"\xac\x04\n\x10BackNotification\x12V\n\x12priva\
    cy_mode_state\x18\x01\x20\x01(\x0e2&.hbb.BackNotification.PrivacyModeSta\
    teH\0R\x10privacyModeState\x12S\n\x11block_input_state\x18\x02\x20\x01(\
    \x0e2%.hbb.BackNotification.BlockInputStateH\0R\x0fblockInputState\"r\n\
    \x0fBlockInputState\x12\x13\n\x0fBlkStateUnknown\x10\0\x12\x12\n\x0eBlkO\
    nSucceeded\x10\x02\x12\x0f\n\x0bBlkOnFailed\x10\x03\x12\x13\n\x0fBlkOffS\
    ucceeded\x10\x04\x12\x10\n\x0cBlkOffFailed\x10\x05\"\xed\x01\n\x10Privac\
    yModeState\x12\x13\n\x0fPrvStateUnknown\x10\0\x12\x10\n\x0cPrvOnByOther\
    \x10\x02\x12\x13\n\x0fPrvNotSupported\x10\x03\x12\x12\n\x0ePrvOnSucceede\
    d\x10\x04\x12\x15\n\x11PrvOnFailedDenied\x10\x05\x12\x15\n\x11PrvOnFaile\
    dPlugin\x10\x06\x12\x0f\n\x0bPrvOnFailed\x10\x07\x12\x13\n\x0fPrvOffSucc\
    eeded\x10\x08\x12\x10\n\x0cPrvOffByPeer\x10\t\x12\x10\n\x0cPrvOffFailed\
    \x10\n\x12\x11\n\rPrvOffUnknown\x10\x0bB\x07\n\x05union\"\x92\x05\n\x04M\
    isc\x125\n\x0cchat_message\x18\x04\x20\x01(\x0b2\x10.hbb.ChatMessageH\0R\
    \x0bchatMessage\x12;\n\x0eswitch_display\x18\x05\x20\x01(\x0b2\x12.hbb.S\
    witchDisplayH\0R\rswitchDisplay\x12>\n\x0fpermission_info\x18\x06\x20\
    \x01(\x0b2\x13.hbb.PermissionInfoH\0R\x0epermissionInfo\x12,\n\x06option\
    \x18\x07\x20\x01(\x0b2\x12.hbb.OptionMessageH\0R\x06option\x125\n\x0caud\
    io_format\x18\x08\x20\x01(\x0b2\x10.hbb.AudioFormatH\0R\x0baudioFormat\
    \x12#\n\x0cclose_reason\x18\t\x20\x01(\tH\0R\x0bcloseReason\x12%\n\rrefr\
    esh_video\x18\n\x20\x01(\x08H\0R\x0crefreshVideo\x12'\n\x0evideo_receive\
    d\x18\x0c\x20\x01(\x08H\0R\rvideoReceived\x12D\n\x11back_notification\
    \x18\r\x20\x01(\x0b2\x15.hbb.BackNotificationH\0R\x10backNotification\
    \x124\n\x15restart_remote_device\x18\x0e\x20\x01(\x08H\0R\x13restartRemo\
    teDevice\x12\x12\n\x03uac\x18\x0f\x20\x01(\x08H\0R\x03uac\x12>\n\x1afore\
    ground_window_elevated\x18\x10\x20\x01(\x08H\0R\x18foregroundWindowEleva\
    ted\x12#\n\x0cstop_service\x18\x11\x20\x01(\x08H\0R\x0bstopServiceB\x07\
    \n\x05union\"\xb4\x07\n\x07Message\x12,\n\tsigned_id\x18\x03\x20\x01(\
    \x0b2\r.hbb.SignedIdH\0R\x08signedId\x12/\n\npublic_key\x18\x04\x20\x01(\
    \x0b2\x0e.hbb.PublicKeyH\0R\tpublicKey\x12/\n\ntest_delay\x18\x05\x20\
    \x01(\x0b2\x0e.hbb.TestDelayH\0R\ttestDelay\x122\n\x0bvideo_frame\x18\
    \x06\x20\x01(\x0b2\x0f.hbb.VideoFrameH\0R\nvideoFrame\x128\n\rlogin_requ\
    est\x18\x07\x20\x01(\x0b2\x11.hbb.LoginRequestH\0R\x0cloginRequest\x12;\
    \n\x0elogin_response\x18\x08\x20\x01(\x0b2\x12.hbb.LoginResponseH\0R\rlo\
    ginResponse\x12\x1f\n\x04hash\x18\t\x20\x01(\x0b2\t.hbb.HashH\0R\x04hash\
    \x122\n\x0bmouse_event\x18\n\x20\x01(\x0b2\x0f.hbb.MouseEventH\0R\nmouse\
    Event\x122\n\x0baudio_frame\x18\x0b\x20\x01(\x0b2\x0f.hbb.AudioFrameH\0R\
    \naudioFrame\x122\n\x0bcursor_data\x18\x0c\x20\x01(\x0b2\x0f.hbb.CursorD\
    ataH\0R\ncursorData\x12>\n\x0fcursor_position\x18\r\x20\x01(\x0b2\x13.hb\
    b.CursorPositionH\0R\x0ecursorPosition\x12\x1d\n\tcursor_id\x18\x0e\x20\
    \x01(\x04H\0R\x08cursorId\x12,\n\tkey_event\x18\x0f\x20\x01(\x0b2\r.hbb.\
    KeyEventH\0R\x08keyEvent\x12.\n\tclipboard\x18\x10\x20\x01(\x0b2\x0e.hbb\
    .ClipboardH\0R\tclipboard\x122\n\x0bfile_action\x18\x11\x20\x01(\x0b2\
    \x0f.hbb.FileActionH\0R\nfileAction\x128\n\rfile_response\x18\x12\x20\
    \x01(\x0b2\x11.hbb.FileResponseH\0R\x0cfileResponse\x12\x1f\n\x04misc\
    \x18\x13\x20\x01(\x0b2\t.hbb.MiscH\0R\x04misc\x12(\n\x07cliprdr\x18\x14\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            let mut messages = ::std::vec::Vec::with_capacity(60);
            ...
            enums.push(video_codec_state::PerferCodec::generated_enum_descriptor_data());
